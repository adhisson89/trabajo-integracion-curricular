...
describe('InicioSesionComponent', () => {
  ...
  it('should create a form with empty username and password', () => {
    console.log('Verificando que el formulario esté creado con los campos vacíos...');
  ...
  it('should make the form valid when username and password are filled', () => {
    console.log('Verificando que el formulario se valide cuando los campos estén completos...');
...
it('should call onSubmit and make a POST request when the form is valid', async () => {
  console.log('Verificando que el método onSubmit se llama cuando el formulario es válido...');
  ...
  console.log('onSubmit llamada exitosamente, solicitud POST realizada.');
})
