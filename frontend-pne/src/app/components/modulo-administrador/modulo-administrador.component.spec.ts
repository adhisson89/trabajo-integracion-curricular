...
it('should call redirectTo with correct route', () => {
 ...
 console.log('FrontEnd Policia Nacional del Ecuador Prueba de redirección ejecutada. La función navigate fue llamada con la ruta: ', route);
});
...
it('should apply the correct CSS classes to module divs', () => {
  ...
  moduleElements.forEach((module) => {
   ...
   console.log('FrontEnd Policia Nacional del Ecuador Clase CSS "module" aplicada correctamente:', classList);
  });
});
