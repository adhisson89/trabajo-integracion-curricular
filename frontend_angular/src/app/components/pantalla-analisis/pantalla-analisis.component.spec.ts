...
describe('PantallaAnalisisComponent', () => {
  ...
  it('should reset inactivity timer on user activity', () => {
   console.log('FrontEnd Policia Nacional del Ecuador Actividad del usuario detectada');
  ...
  it('should initialize videoRef on ngOnInit', async () => {
   console.log('FrontEnd Policia Nacional del Ecuador Inicialización de videoRef en ngOnInit');
  ...
  it('should load face-api.js models', async () => {
   console.log('FrontEnd Policia Nacional del Ecuador Carga de modelos de face-api.js');
    spyOn(console, 'log');
    spyOn(console, 'error');
  ...
  it('should stop camera and intervals on ngOnDestroy', () => {
   console.log('FrontEnd Policia Nacional del Ecuador Detención de cámara y temporizadores en ngOnDestroy');
    spyOn(window, 'clearTimeout');
  ...
  it('should send image blob to backend', async () => {
   console.log('FrontEnd Policia Nacional del Ecuador Envío de imagen blob al backend'); 
  ...
  it('should handle active camera state correctly', () => {
   console.log('FrontEnd Policia Nacional del Ecuador Imagen capturada y camara activa');
